                    ...
                    <CardHeader className="p-4 sm:p-6">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            ...
                            <div className="flex gap-1.5 sm:gap-2">
                                <button className="min-h-[36px] sm:min-h-[40px] px-2.5 sm:px-3 py-1.5 text-xs font-medium rounded-md bg-primary/10 text-primary transition-colors">
                                    Semana
                                </button>
            ...
            <Card className="bg-card/60 backdrop-blur border-border/60">
                <CardHeader className="p-4 sm:p-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                        ...
                        <button className="text-xs sm:text-sm text-primary hover:underline self-start sm:self-auto min-h-[44px] flex items-center">
                            Ver todo
                        </button>
                    </div>
                </CardHeader>
