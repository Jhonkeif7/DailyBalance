...
| `sm:` | 640px (40rem) | Large phones, small tablets | `@media (min-inline-size: 640px)` |
| `md:` | 768px (48rem) | Tablets (portrait) | `@media (min-inline-size: 768px)` |
| `lg:` | 1024px (64rem) | Tablets (landscape), laptops | `@media (min-inline-size: 1024px)` |
| `xl:` | 1280px (80rem) | Desktops | `@media (min-inline-size: 1280px)` |
| `2xl:` | 1536px (96rem) | Large desktops | `@media (min-inline-size: 1536px)` |
...
<div class="[@media(max-inline-size:600px)]:text-sm">
  Custom max-width
</div>
```
...
<img
  ...
  sizes="(min-inline-size: 1024px) 50vw, 100vw"
